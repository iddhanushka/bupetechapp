<template>
  <section class="contact" :style="{ backgroundImage: 'url(' + require(`@/assets/images/call-center.png`) + ')', backgroundRepeat:'no-repeat' , backgroundSize: 'cover'}"  >
                  ...
                  <div class="col-xl-6">
                    <div class="train-mothod">
                      <div class="term-block">
                        ...
                        <h4 class="term-block__title">Contact Sales</h4>
                        <p>Talk with our solutions team for find how we can add value to your business.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6">
                    <div class="train-mothod">
                      <div class="term-block">
                        <img class="term-block__icon" src="../assets/images/head-phone.png" alt="">
                        <h4 class="term-block__title">Contact Technical Support</h4>
                        <p>Lets see what we can do with your support request.</p>
                      </div>
                    </div>
                  </div>
                </div>
